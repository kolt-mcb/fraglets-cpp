...
distdir: FORCE
	...
	$(COPY_FILE) --parents fraglets.h keymultiset.h moleculemultiset.h $(DISTDIR)/
	$(COPY_FILE) --parents fraglets.cpp keymultiset.cpp main.cpp moleculemultiset.cpp $(DISTDIR)/
...
fraglets.o: fraglets.cpp fraglets.h \
		keymultiset.h \
		moleculemultiset.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o fraglets.o fraglets.cpp

keymultiset.o: keymultiset.cpp keymultiset.h \
		moleculemultiset.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o keymultiset.o keymultiset.cpp

main.o: main.cpp fraglets.h \
		keymultiset.h \
		moleculemultiset.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o main.o main.cpp

moleculemultiset.o: moleculemultiset.cpp moleculemultiset.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o moleculemultiset.o moleculemultiset.cpp
